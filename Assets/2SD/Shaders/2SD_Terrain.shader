...
Shader "2SD/2SD_Terrain"
{
	Properties
	{
		...
		_normalscaleveryclose("normal scale very close", Range( 0 , 1)) = 1
		_normalscaleclose("normal scale close", Range( 0 , 1)) = 1
		_normalscalemid("normal scale mid", Range( 0 , 1)) = 1
		_normalscalefar("normal scale far", Range( 0 , 1)) = 1
		_Control("Control", 2D) = "white" {}
		[Normal]_globalnormal("global normal", 2D) = "bump" {}
		_globalnormalstrength("global normal strength", Range( -1 , 1)) = 1
		_closeglobalnormal("close global normal", Range( 0 , 1)) = 1
		_closedetailglobalstrength("close detail global strength", Range( 0 , 1)) = 0
		_closenoisenormalscale("close noise normal scale", Range( 0 , 3)) = 1
		_closesmalldetailscale("close small detail scale", Range( 0 , 200)) = 128
		_closedetailDetail0("close detail Detail 0", Range( 0 , 1)) = 1
		_closedetailDetail1("close detail Detail 1", Range( 0 , 1)) = 1
		_closedetailDetail2("close detail Detail 2", Range( 0 , 1)) = 1
		_closedetailDetail3("close detail Detail 3", Range( 0 , 1)) = 1
		_globalcolor("global color", 2D) = "white" {}
		_GlobalColorMultiplier("Global Color Multiplier", Range( 0 , 1)) = 0.85
		_globalColorVeryCloseMultiplier("globalColorVeryCloseMultiplier", Range( 0 , 1)) = 0
		_globalColorCloseMultiplier("globalColorCloseMultiplier", Range( 0 , 1)) = 1
		_globalColorMidMultiplier("globalColorMidMultiplier", Range( 0 , 1)) = 0
		...
		_snowSpeckle("snowSpeckle", 2D) = "white" {}
		...
		_specklecontrast("speckle contrast", Range( 1 , 5)) = 1
		_snowspecklestrength("snow speckle strength", Range( 0 , 1)) = 0
		_snowspecklestrengthdetail0("snow speckle strength detail 0", Range( 0 , 1)) = 1
		_snowspecklestrengthdetail1("snow speckle strength detail 1", Range( 0 , 1)) = 1
		_snowspecklestrengthdetail2("snow speckle strength detail 2", Range( 0 , 1)) = 1
		_snowspecklestrengthdetail3("snow speckle strength detail 3", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		uniform float _normalscaleveryclose;
		uniform float _normalscaleclose;
		uniform float _normalscalemid;
		...
		uniform float _closenoisenormalscale;
		uniform float _closesmalldetailscale;
		uniform float _closedetailglobalstrength;
		uniform float _closedetailDetail0;
		uniform float _closedetailDetail1;
		uniform float _closedetailDetail2;
		uniform float _closedetailDetail3;
		...
		uniform float _globalColorVeryCloseMultiplier;
		uniform float _globalColorCloseMultiplier;
		uniform float _globalColorMidMultiplier;
		uniform float _globalColorFarMultiplier;
		uniform sampler2D _snowSpeckle;
		uniform float _specklecontrast;
		uniform float _snowspecklestrength;
		uniform float _snowspecklestrengthdetail0;
		uniform float _snowspecklestrengthdetail1;
		uniform float _snowspecklestrengthdetail2;
		uniform float _snowspecklestrengthdetail3;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_5_0_g1778 = 0.0;
			...
			int temp_output_2_0_g1777 = 0;
			float4 texArray7_g1777 = UNITY_SAMPLE_TEX2DARRAY(_HeightArray, float3(uv_TexCoord2451, (float)temp_output_2_0_g1777)  );
			float4 texArray8_g1777 = UNITY_SAMPLE_TEX2DARRAY(_HeightArray, float3(uv_TexCoord2451, (float)temp_output_2_0_g1777)  );
			float temp_output_14_0_g1771 = i.eyeDepth;
			...
			float temp_output_70_0_g1769 = camDistanceTransition2340;
			float camDistanceMid2343 = _CameraDistanceMid;
			float temp_output_69_0_g1769 = camDistanceMid2343;
			float temp_output_12_0_g1771 = ( camDistanceVeryClose2341 + camDistanceClose2342 + ( temp_output_70_0_g1769 * (0.0 + (i.eyeDepth - 0.0) * (1.0 - 0.0) / (( temp_output_69_0_g1769 + temp_output_70_0_g1769 ) - 0.0)) ) );
			float temp_output_11_0_g1771 = ( temp_output_70_0_g1769 * (0.0 + (i.eyeDepth - 0.0) * (1.0 - 0.0) / (( temp_output_69_0_g1769 + temp_output_70_0_g1769 ) - 0.0)) );
			float temp_output_5_0_g1771 = ( temp_output_12_0_g1771 + temp_output_11_0_g1771 );
			float temp_output_7_0_g1771 = (1.5 + (temp_output_14_0_g1771 - temp_output_12_0_g1771) * (0.0 - 1.5) / (temp_output_5_0_g1771 - temp_output_12_0_g1771));
			float temp_output_14_0_g1772 = i.eyeDepth;
			float temp_output_12_0_g1772 = camDistanceVeryClose2341;
			float temp_output_11_0_g1772 = ( temp_output_70_0_g1769 * (0.0 + (i.eyeDepth - 0.0) * (1.0 - 0.0) / (( temp_output_69_0_g1769 + temp_output_70_0_g1769 ) - 0.0)) );
			float temp_output_5_0_g1772 = ( temp_output_12_0_g1772 + temp_output_11_0_g1772 );
			float temp_output_7_0_g1772 = (1.5 + (temp_output_14_0_g1772 - temp_output_12_0_g1772) * (0.0 - 1.5) / (temp_output_5_0_g1772 - temp_output_12_0_g1772));
			float temp_output_14_0_g1770 = i.eyeDepth;
			float temp_output_12_0_g1770 = ( camDistanceVeryClose2341 + camDistanceClose2342 + temp_output_69_0_g1769 + ( temp_output_70_0_g1769 * (0.0 + (i.eyeDepth - 0.0) * (1.0 - 0.0) / (( temp_output_69_0_g1769 + temp_output_70_0_g1769 ) - 0.0)) ) + ( temp_output_70_0_g1769 * (0.0 + (i.eyeDepth - 0.0) * (1.0 - 0.0) / (( temp_output_69_0_g1769 + temp_output_70_0_g1769 ) - 0.0)) ) );
			float temp_output_11_0_g1770 = ( temp_output_70_0_g1769 * (0.0 + (i.eyeDepth - 0.0) * (1.0 - 0.0) / (( temp_output_69_0_g1769 + temp_output_70_0_g1769 ) - 0.0)) );
			float temp_output_5_0_g1770 = ( temp_output_12_0_g1770 + temp_output_11_0_g1770 );
			float temp_output_7_0_g1770 = (1.5 + (temp_output_14_0_g1770 - temp_output_12_0_g1770) * (0.0 - 1.5) / (temp_output_5_0_g1770 - temp_output_12_0_g1770));
			float temp_output_2470_71 = ( saturate( ( temp_output_7_0_g1771 * (0.0 + (temp_output_14_0_g1771 - ( temp_output_12_0_g1771 - temp_output_11_0_g1771 )) * (1.5 - 0.0) / (temp_output_5_0_g1771 - ( temp_output_12_0_g1771 - temp_output_11_0_g1771 ))) ) ) + saturate( ( temp_output_7_0_g1772 * (0.0 + (temp_output_14_0_g1772 - ( temp_output_12_0_g1772 - temp_output_11_0_g1772 )) * (1.5 - 0.0) / (temp_output_5_0_g1772 - ( temp_output_12_0_g1772 - temp_output_11_0_g1772 ))) ) ) + saturate( ( temp_output_7_0_g1770 * (0.0 + (temp_output_14_0_g1770 - ( temp_output_12_0_g1770 - temp_output_11_0_g1770 )) * (1.5 - 0.0) / (temp_output_5_0_g1770 - ( temp_output_12_0_g1770 - temp_output_11_0_g1770 ))) ) ) );
			float UV_t2408 = temp_output_2470_71;
			float4 lerpResult4_g1777 = lerp( texArray7_g1777 , texArray8_g1777 , UV_t2408);
			int temp_output_2_0_g1774 = 1;
			float4 texArray7_g1774 = UNITY_SAMPLE_TEX2DARRAY(_HeightArray, float3(uv_TexCoord2451, (float)temp_output_2_0_g1774)  );
			float4 texArray8_g1774 = UNITY_SAMPLE_TEX2DARRAY(_HeightArray, float3(uv_TexCoord2451, (float)temp_output_2_0_g1774)  );
			float4 lerpResult4_g1774 = lerp( texArray7_g1774 , texArray8_g1774 , UV_t2408);
			int temp_output_2_0_g1776 = 2;
			float4 texArray7_g1776 = UNITY_SAMPLE_TEX2DARRAY(_HeightArray, float3(uv_TexCoord2451, (float)temp_output_2_0_g1776)  );
			float4 texArray8_g1776 = UNITY_SAMPLE_TEX2DARRAY(_HeightArray, float3(uv_TexCoord2451, (float)temp_output_2_0_g1776)  );
			float4 lerpResult4_g1776 = lerp( texArray7_g1776 , texArray8_g1776 , UV_t2408);
			int temp_output_2_0_g1775 = 3;
			float4 texArray7_g1775 = UNITY_SAMPLE_TEX2DARRAY(_HeightArray, float3(uv_TexCoord2451, (float)temp_output_2_0_g1775)  );
			float4 texArray8_g1775 = UNITY_SAMPLE_TEX2DARRAY(_HeightArray, float3(uv_TexCoord2451, (float)temp_output_2_0_g1775)  );
			float4 lerpResult4_g1775 = lerp( texArray7_g1775 , texArray8_g1775 , UV_t2408);
			float4 appendResult2161 = (float4(lerpResult4_g1777.a , lerpResult4_g1774.a , lerpResult4_g1776.a , lerpResult4_g1775.a));
			float4 temp_cast_9 = (_heightBoost).xxxx;
			float temp_output_4_0_g1778 = ( 1.0 - ( splats1250 * ( pow( appendResult2161 , temp_cast_9 ) * _heightBoost ) ).r );
			float temp_output_14_0_g1778 = _heightstrength;
			float temp_output_2320_21 = saturate( ( ( saturate( ( ( splats1250.r - min( temp_output_5_0_g1778 , temp_output_4_0_g1778 ) ) / max( abs( ( temp_output_5_0_g1778 - temp_output_4_0_g1778 ) ) , 0.001 ) ) ) - temp_output_14_0_g1778 ) / max( 0.001 , ( 1.0 - temp_output_14_0_g1778 ) ) ) );
			float temp_output_5_0_g1779 = ( temp_output_2320_21 * splats1250.r );
			float4 temp_cast_11 = (_heightBoost).xxxx;
			float temp_output_4_0_g1779 = ( 1.0 - ( splats1250 * ( pow( appendResult2161 , temp_cast_11 ) * _heightBoost ) ).g );
			float temp_output_14_0_g1779 = _heightstrength;
			float temp_output_2318_21 = saturate( ( ( saturate( ( ( splats1250.g - min( temp_output_5_0_g1779 , temp_output_4_0_g1779 ) ) / max( abs( ( temp_output_5_0_g1779 - temp_output_4_0_g1779 ) ) , 0.001 ) ) ) - temp_output_14_0_g1779 ) / max( 0.001 , ( 1.0 - temp_output_14_0_g1779 ) ) ) );
			float temp_output_5_0_g1780 = ( temp_output_2318_21 * splats1250.g );
			float4 temp_cast_13 = (_heightBoost).xxxx;
			float temp_output_4_0_g1780 = ( 1.0 - ( splats1250 * ( pow( appendResult2161 , temp_cast_13 ) * _heightBoost ) ).b );
			float temp_output_14_0_g1780 = _heightstrength;
			float temp_output_2319_21 = saturate( ( ( saturate( ( ( splats1250.b - min( temp_output_5_0_g1780 , temp_output_4_0_g1780 ) ) / max( abs( ( temp_output_5_0_g1780 - temp_output_4_0_g1780 ) ) , 0.001 ) ) ) - temp_output_14_0_g1780 ) / max( 0.001 , ( 1.0 - temp_output_14_0_g1780 ) ) ) );
			float temp_output_1796_0 = ( 1.0 - max( temp_output_2319_21 , max( temp_output_2320_21 , temp_output_2318_21 ) ) );
			float temp_output_5_0_g1781 = ( temp_output_2319_21 * splats1250.b );
			float4 temp_cast_15 = (_heightBoost).xxxx;
			float temp_output_4_0_g1781 = ( 1.0 - ( splats1250 * ( pow( appendResult2161 , temp_cast_15 ) * _heightBoost ) ).a );
			float temp_output_14_0_g1781 = _heightstrength;
			float4 appendResult2079 = (float4(max( temp_output_2320_21 , ( splats1250.r * temp_output_1796_0 ) ) , max( temp_output_2318_21 , ( splats1250.g * temp_output_1796_0 ) ) , max( temp_output_2319_21 , ( splats1250.b * temp_output_1796_0 ) ) , max( saturate( ( ( saturate( ( ( splats1250.a - min( temp_output_5_0_g1781 , temp_output_4_0_g1781 ) ) / max( abs( ( temp_output_5_0_g1781 - temp_output_4_0_g1781 ) ) , 0.001 ) ) ) - temp_output_14_0_g1781 ) / max( 0.001 , ( 1.0 - temp_output_14_0_g1781 ) ) ) ) , ( splats1250.a * temp_output_1796_0 ) )));
			...
			float lerpResult95_g1769 = lerp( baseuvtiling400 , closeUV529 , saturate( (0.0 + (temp_output_14_0_g1772 - temp_output_12_0_g1772) * (1.5 - 0.0) / (temp_output_12_0_g1772 - temp_output_12_0_g1772)) ));
			float temp_output_1689_0 = ( _uvmultiplier * 2.0 );
			float midUV577 = ( baseuvtiling400 / temp_output_1689_0 );
			float lerpResult50_g1769 = lerp( lerpResult95_g1769 , midUV577 , saturate( (0.0 + (temp_output_14_0_g1771 - temp_output_12_0_g1771) * (1.5 - 0.0) / (temp_output_12_0_g1771 - temp_output_12_0_g1771)) ));
			float farUV578 = ( baseuvtiling400 / ( temp_output_1689_0 * 2.0 ) );
			float temp_output_67_0_g1769 = farUV578;
			float temp_output_136_19_g1769 = saturate( (0.0 + (temp_output_14_0_g1770 - temp_output_12_0_g1770) * (1.5 - 0.0) / (temp_output_12_0_g1770 - temp_output_12_0_g1770)) );
			float lerpResult55_g1769 = lerp( lerpResult50_g1769 , temp_output_67_0_g1769 , temp_output_136_19_g1769);
			float2 temp_cast_20 = (lerpResult55_g1769).xx;
			float2 uv_TexCoord59_g1769 = i.uv_texcoord * temp_cast_20 + float2( 0,0 );
			float2 UV_A2406 = uv_TexCoord59_g1769;
			int temp_output_2_0_g1793 = 0;
			float temp_output_16_0_g1787 = camDistanceVeryClose2341;
			float temp_output_1_0_g1787 = camDistanceTransition2340;
			float cameraCloseDepth273 = saturate( (0.0 + (i.eyeDepth - temp_output_16_0_g1787) * (1.0 - 0.0) / (( temp_output_1_0_g1787 + temp_output_16_0_g1787 ) - temp_output_16_0_g1787)) );
			float temp_output_24_0_g1788 = cameraCloseDepth273;
			float temp_output_17_0_g1787 = camDistanceClose2342;
			float cameraMidDepth279 = saturate( (0.0 + (i.eyeDepth - temp_output_17_0_g1787) * (1.0 - 0.0) / (( temp_output_1_0_g1787 + temp_output_17_0_g1787 ) - temp_output_17_0_g1787)) );
			float temp_output_25_0_g1788 = cameraMidDepth279;
			float temp_output_19_0_g1787 = camDistanceMid2343;
			float cameraFarDepth281 = saturate( (0.0 + (i.eyeDepth - temp_output_19_0_g1787) * (1.0 - 0.0) / (( temp_output_19_0_g1787 + temp_output_1_0_g1787 ) - temp_output_19_0_g1787)) );
			float temp_output_26_0_g1788 = cameraFarDepth281;
			float temp_output_10_0_g1793 = ( _normalScale * ( ( _normalscaleveryclose * ( 1.0 - temp_output_24_0_g1788 ) ) + ( ( temp_output_24_0_g1788 - temp_output_25_0_g1788 ) * _normalscaleclose ) + ( ( temp_output_25_0_g1788 - temp_output_26_0_g1788 ) * _normalscalemid ) + ( temp_output_26_0_g1788 * _normalscalefar ) ) );
			float3 texArray9_g1793 = UnpackScaleNormal( UNITY_SAMPLE_TEX2DARRAY(_NormalArray, float3(UV_A2406, (float)temp_output_2_0_g1793)  ) ,temp_output_10_0_g1793 );
			float temp_output_134_13_g1769 = ceil( saturate( temp_output_7_0_g1772 ) );
			float lerpResult114_g1769 = lerp( baseuvtiling400 , closeUV529 , temp_output_134_13_g1769);
			float temp_output_135_13_g1769 = ceil( saturate( temp_output_7_0_g1771 ) );
			float lerpResult109_g1769 = lerp( lerpResult114_g1769 , midUV577 , ( temp_output_135_13_g1769 - temp_output_134_13_g1769 ));
			float lerpResult110_g1769 = lerp( lerpResult109_g1769 , temp_output_67_0_g1769 , ( saturate( ( ceil( saturate( temp_output_7_0_g1770 ) ) + temp_output_136_19_g1769 ) ) - temp_output_135_13_g1769 ));
			float2 temp_cast_22 = (lerpResult110_g1769).xx;
			float2 uv_TexCoord60_g1769 = i.uv_texcoord * temp_cast_22 + float2( 0,0 );
			float2 UV_B2407 = uv_TexCoord60_g1769;
			float3 texArray6_g1793 = UnpackScaleNormal( UNITY_SAMPLE_TEX2DARRAY(_NormalArray, float3(UV_B2407, (float)temp_output_2_0_g1793)  ) ,temp_output_10_0_g1793 );
			float3 lerpResult5_g1793 = lerp( texArray9_g1793 , texArray6_g1793 , UV_t2408);
			int temp_output_2_0_g1790 = 1;
			float temp_output_10_0_g1790 = ( _normalScale * ( ( _normalscaleveryclose * ( 1.0 - temp_output_24_0_g1788 ) ) + ( ( temp_output_24_0_g1788 - temp_output_25_0_g1788 ) * _normalscaleclose ) + ( ( temp_output_25_0_g1788 - temp_output_26_0_g1788 ) * _normalscalemid ) + ( temp_output_26_0_g1788 * _normalscalefar ) ) );
			float3 texArray9_g1790 = UnpackScaleNormal( UNITY_SAMPLE_TEX2DARRAY(_NormalArray, float3(UV_A2406, (float)temp_output_2_0_g1790)  ) ,temp_output_10_0_g1790 );
			float3 texArray6_g1790 = UnpackScaleNormal( UNITY_SAMPLE_TEX2DARRAY(_NormalArray, float3(UV_B2407, (float)temp_output_2_0_g1790)  ) ,temp_output_10_0_g1790 );
			float3 lerpResult5_g1790 = lerp( texArray9_g1790 , texArray6_g1790 , UV_t2408);
			int temp_output_2_0_g1791 = 2;
			float temp_output_10_0_g1791 = ( _normalScale * ( ( _normalscaleveryclose * ( 1.0 - temp_output_24_0_g1788 ) ) + ( ( temp_output_24_0_g1788 - temp_output_25_0_g1788 ) * _normalscaleclose ) + ( ( temp_output_25_0_g1788 - temp_output_26_0_g1788 ) * _normalscalemid ) + ( temp_output_26_0_g1788 * _normalscalefar ) ) );
			float3 texArray9_g1791 = UnpackScaleNormal( UNITY_SAMPLE_TEX2DARRAY(_NormalArray, float3(UV_A2406, (float)temp_output_2_0_g1791)  ) ,temp_output_10_0_g1791 );
			float3 texArray6_g1791 = UnpackScaleNormal( UNITY_SAMPLE_TEX2DARRAY(_NormalArray, float3(UV_B2407, (float)temp_output_2_0_g1791)  ) ,temp_output_10_0_g1791 );
			float3 lerpResult5_g1791 = lerp( texArray9_g1791 , texArray6_g1791 , UV_t2408);
			int temp_output_2_0_g1792 = 3;
			float temp_output_10_0_g1792 = ( _normalScale * ( ( _normalscaleveryclose * ( 1.0 - temp_output_24_0_g1788 ) ) + ( ( temp_output_24_0_g1788 - temp_output_25_0_g1788 ) * _normalscaleclose ) + ( ( temp_output_25_0_g1788 - temp_output_26_0_g1788 ) * _normalscalemid ) + ( temp_output_26_0_g1788 * _normalscalefar ) ) );
			float3 texArray9_g1792 = UnpackScaleNormal( UNITY_SAMPLE_TEX2DARRAY(_NormalArray, float3(UV_A2406, (float)temp_output_2_0_g1792)  ) ,temp_output_10_0_g1792 );
			float3 texArray6_g1792 = UnpackScaleNormal( UNITY_SAMPLE_TEX2DARRAY(_NormalArray, float3(UV_B2407, (float)temp_output_2_0_g1792)  ) ,temp_output_10_0_g1792 );
			float3 lerpResult5_g1792 = lerp( texArray9_g1792 , texArray6_g1792 , UV_t2408);
			float4 weightedBlendVar1978 = modifiedWeights618;
			float3 weightedAvg1978 = ( ( weightedBlendVar1978.x*lerpResult5_g1793 + weightedBlendVar1978.y*lerpResult5_g1790 + weightedBlendVar1978.z*lerpResult5_g1791 + weightedBlendVar1978.w*lerpResult5_g1792 )/( weightedBlendVar1978.x + weightedBlendVar1978.y + weightedBlendVar1978.z + weightedBlendVar1978.w ) );
			...
			float2 temp_cast_30 = (( _closesmalldetailscale * 4 )).xx;
			float2 uv_TexCoord155 = i.uv_texcoord * temp_cast_30 + float2( 0,0 );
			float4 weightedBlendVar2307 = modifiedWeights618;
			float weightedAvg2307 = ( ( weightedBlendVar2307.x*_closedetailDetail0 + weightedBlendVar2307.y*_closedetailDetail1 + weightedBlendVar2307.z*_closedetailDetail2 + weightedBlendVar2307.w*_closedetailDetail3 )/( weightedBlendVar2307.x + weightedBlendVar2307.y + weightedBlendVar2307.z + weightedBlendVar2307.w ) );
			float3 lerpResult153 = lerp( lerpResult1109 , BlendNormals( lerpResult1109 , UnpackScaleNormal( tex2D( _combined, uv_TexCoord155 ) ,_closenoisenormalscale ) ) , saturate( ( _closedetailglobalstrength * saturate( ( 1.0 - cameraCloseDepth273 ) ) * weightedAvg2307 ) ));
			float3 normalizeResult209 = normalize( lerpResult153 );
			float3 endNormal192 = normalizeResult209;
			o.Normal = endNormal192;
			float2 temp_cast_31 = (farUV578).xx;
			float4 tex2DNode1989 = tex2D( _grungemap, temp_cast_31 );
			int temp_output_2_0_g1786 = 0;
			float4 texArray7_g1786 = UNITY_SAMPLE_TEX2DARRAY(_AlbedoArray, float3(UV_A2406, (float)temp_output_2_0_g1786)  );
			float4 texArray8_g1786 = UNITY_SAMPLE_TEX2DARRAY(_AlbedoArray, float3(UV_B2407, (float)temp_output_2_0_g1786)  );
			float4 lerpResult4_g1786 = lerp( texArray7_g1786 , texArray8_g1786 , UV_t2408);
			float4 temp_output_2428_43 = lerpResult4_g1786;
			float4 lerpResult1997 = lerp( ( tex2DNode1989.r * temp_output_2428_43 ) , temp_output_2428_43 , 0.25);
			int temp_output_2_0_g1783 = 1;
			float4 texArray7_g1783 = UNITY_SAMPLE_TEX2DARRAY(_AlbedoArray, float3(UV_A2406, (float)temp_output_2_0_g1783)  );
			float4 texArray8_g1783 = UNITY_SAMPLE_TEX2DARRAY(_AlbedoArray, float3(UV_B2407, (float)temp_output_2_0_g1783)  );
			float4 lerpResult4_g1783 = lerp( texArray7_g1783 , texArray8_g1783 , UV_t2408);
			float4 temp_output_2428_44 = lerpResult4_g1783;
			float4 lerpResult1999 = lerp( ( ( ( tex2DNode1989.r - tex2DNode1989.g ) + tex2DNode1989.g ) * temp_output_2428_44 ) , temp_output_2428_44 , 0.25);
			int temp_output_2_0_g1785 = 2;
			float4 texArray7_g1785 = UNITY_SAMPLE_TEX2DARRAY(_AlbedoArray, float3(UV_A2406, (float)temp_output_2_0_g1785)  );
			float4 texArray8_g1785 = UNITY_SAMPLE_TEX2DARRAY(_AlbedoArray, float3(UV_B2407, (float)temp_output_2_0_g1785)  );
			float4 lerpResult4_g1785 = lerp( texArray7_g1785 , texArray8_g1785 , UV_t2408);
			float4 temp_output_2428_46 = lerpResult4_g1785;
			float4 lerpResult2000 = lerp( ( tex2DNode1989.b * temp_output_2428_46 ) , temp_output_2428_46 , 0.25);
			int temp_output_2_0_g1784 = 3;
			float4 texArray7_g1784 = UNITY_SAMPLE_TEX2DARRAY(_AlbedoArray, float3(UV_A2406, (float)temp_output_2_0_g1784)  );
			float4 texArray8_g1784 = UNITY_SAMPLE_TEX2DARRAY(_AlbedoArray, float3(UV_B2407, (float)temp_output_2_0_g1784)  );
			float4 lerpResult4_g1784 = lerp( texArray7_g1784 , texArray8_g1784 , UV_t2408);
			float4 temp_output_2428_48 = lerpResult4_g1784;
			...
			float2 temp_cast_42 = (temp_output_1327_0).xx;
			float2 lerpResult1336 = lerp( ( uv_TexCoord1323 - temp_cast_42 ) , ( uv_TexCoord1323 + temp_output_1327_0 ) , ( localUnpackNormal1818.x + localUnpackNormal1818.z ));
			...
			float temp_output_24_0_g1794 = cameraCloseDepth273;
			float temp_output_25_0_g1794 = cameraMidDepth279;
			float temp_output_26_0_g1794 = cameraFarDepth281;
			float temp_output_2449_0 = ( _GlobalColorMultiplier * ( ( _globalColorVeryCloseMultiplier * ( 1.0 - temp_output_24_0_g1794 ) ) + ( ( temp_output_24_0_g1794 - temp_output_25_0_g1794 ) * _globalColorCloseMultiplier ) + ( ( temp_output_25_0_g1794 - temp_output_26_0_g1794 ) * _globalColorMidMultiplier ) + ( temp_output_26_0_g1794 * _globalColorFarMultiplier ) ) );
			float4 lerpResult26 = lerp( weightedAvg1945 , ( weightedAvg1945 * tex2DNode4 ) , saturate( ( weightedAvg748 * temp_output_2449_0 ) ));
			float4 endAlbedo2165 = lerpResult26;
			o.Albedo = endAlbedo2165.rgb;
			float4 tex2DNode1962 = tex2D( _snowSpeckle, uv_TexCoord155 );
			float4 weightedBlendVar2284 = modifiedWeights618;
			float weightedAvg2284 = ( ( weightedBlendVar2284.x*_snowspecklestrengthdetail0 + weightedBlendVar2284.y*_snowspecklestrengthdetail1 + weightedBlendVar2284.z*_snowspecklestrengthdetail2 + weightedBlendVar2284.w*_snowspecklestrengthdetail3 )/( weightedBlendVar2284.x + weightedBlendVar2284.y + weightedBlendVar2284.z + weightedBlendVar2284.w ) );
			float lerpResult145 = lerp( ( weightedAvg1945.a + ( pow( tex2DNode1962.r , _specklecontrast ) * _snowspecklestrength * weightedAvg2284 ) ) , tex2DNode4.a , min( ( 1.0 * cameraCloseDepth273 ) , 0.5 ));
			...
			float weightedAvg2162 = ( ( weightedBlendVar2162.x*lerpResult4_g1777.r + weightedBlendVar2162.y*lerpResult4_g1774.r + weightedBlendVar2162.z*lerpResult4_g1776.r + weightedBlendVar2162.w*lerpResult4_g1775.r )/( weightedBlendVar2162.x + weightedBlendVar2162.y + weightedBlendVar2162.z + weightedBlendVar2162.w ) );
	...
	Dependency "BaseMapShader"="2SD/2SD_Terrain_Far"
	Fallback "Diffuse"
	CustomEditor "ASEMaterialInspector"
}
/*ASEBEGIN
Version=14201
-1913;70;1906;1004;6646.587;1413.885;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;304;-4637.702,28.49999;Float;False;Property;_uvmultiplier;uv multiplier;31;0;Create;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-4450.271,-1114.536;Float;False;Property;_Tiling;Tiling;30;0;Create;128;128;1;256;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2470;-6010.487,-1043.822;Float;False;DepthBasedUVFunction;-1;;1769;bb53ce8f7e6ec484bb3fb671bad36bcf;8;72;FLOAT;32.0;False;65;FLOAT;32.0;False;66;FLOAT;16.0;False;67;FLOAT;4.0;False;73;FLOAT;30.0;False;68;FLOAT;30.0;False;69;FLOAT;20.0;False;70;FLOAT;10.0;False;3;FLOAT2;0;FLOAT2;64;FLOAT;71
...
Node;AmplifyShaderEditor.FunctionNode;2427;-4994.669,3401.641;Float;False;TextureArrayDistanceLerp4Textures;-1;;1773;aefb61c81df35c143bffe9e803d17738;4;141;FLOAT2;0,0;False;142;FLOAT2;0,0;False;145;FLOAT;0.0;False;24;SAMPLER2D;0,0,0,0;False;4;COLOR;43;COLOR;44;COLOR;46;COLOR;48
...
Node;AmplifyShaderEditor.SamplerNode;2;-6324.869,-281.4873;Float;True;Property;_Control;Control;8;0;Create;18e8233ca7621044c8942eeeb54a960d;18e8233ca7621044c8942eeeb54a960d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;2320;-2769.621,3081.336;Float;False;HeightBlendFunction;-1;;1778;31570aaae7e29904498342c8c3bdad00;4;5;FLOAT;0.0;False;3;FLOAT;0.0;False;10;FLOAT;0.0;False;14;FLOAT;0.0;False;1;FLOAT;21
...
Node;AmplifyShaderEditor.FunctionNode;2318;-2758.128,3258.32;Float;False;HeightBlendFunction;-1;;1779;31570aaae7e29904498342c8c3bdad00;4;5;FLOAT;0.0;False;3;FLOAT;0.0;False;10;FLOAT;0.0;False;14;FLOAT;0.0;False;1;FLOAT;21
...
Node;AmplifyShaderEditor.FunctionNode;2319;-2754.728,3426.818;Float;False;HeightBlendFunction;-1;;1780;31570aaae7e29904498342c8c3bdad00;4;5;FLOAT;0.0;False;3;FLOAT;0.0;False;10;FLOAT;0.0;False;14;FLOAT;0.0;False;1;FLOAT;21
...
Node;AmplifyShaderEditor.FunctionNode;2317;-2757.428,3674.016;Float;False;HeightBlendFunction;-1;;1781;31570aaae7e29904498342c8c3bdad00;4;5;FLOAT;0.0;False;3;FLOAT;0.0;False;10;FLOAT;0.0;False;14;FLOAT;0.0;False;1;FLOAT;21
...
Node;AmplifyShaderEditor.SaturateNode;1944;-868.7568,3247.049;Float;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1375;-660.7222,3240.695;Float;False;heightMask;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1990;-2382.398,-1763.798;Float;True;Property;_grungemap;grunge map;29;0;Create;None;87109a999d4d5104fa85d68e6877523e;False;white;Auto;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2411;-2388.128,-1219.3;Float;False;2408;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2409;-2385.856,-1364.478;Float;False;2406;0;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;2428;-2078.397,-1395.799;Float;False;TextureArrayDistanceLerp4Textures;-1;;1782;aefb61c81df35c143bffe9e803d17738;4;141;FLOAT2;0,0;False;142;FLOAT2;0,0;False;145;FLOAT;0.0;False;24;SAMPLER2D;0,0,0,0;False;4;COLOR;43;COLOR;44;COLOR;46;COLOR;48
...
Node;AmplifyShaderEditor.FunctionNode;2462;-5516.981,-1748.261;Float;False;CameraDepthMasks;-1;;1787;32c378a12ba127b42a065aeca32fbb55;4;1;FLOAT;0.0;False;16;FLOAT;0.0;False;17;FLOAT;0.0;False;19;FLOAT;0.0;False;3;FLOAT;0;FLOAT;18;FLOAT;20
...
Node;AmplifyShaderEditor.RangedFloatNode;154;182.4356,1559.084;Float;False;Property;_closesmalldetailscale;close small detail scale;14;0;Create;128;141;0;200;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2448;-2317.601,942.0929;Float;False;Distance Based Mask Multiplier;-1;;1788;799ac193d9a7f7a4bae908a42e277362;8;23;FLOAT;1.0;False;19;FLOAT;1.0;False;20;FLOAT;1.0;False;21;FLOAT;1.0;False;22;FLOAT;1.0;False;24;FLOAT;1.0;False;25;FLOAT;1.0;False;26;FLOAT;1.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2403;-1496.5,977.3998;Float;False;TextureArrayDistanceLerp4TexturesNormal;-1;;1789;ddc78be429ca7e549afa78ee1c166e18;5;97;FLOAT2;0,0;False;98;FLOAT2;0,0;False;99;FLOAT;0.0;False;50;FLOAT;1.0;False;24;SAMPLER2D;0,0,0,0;False;4;FLOAT3;43;FLOAT3;44;FLOAT3;46;FLOAT3;48
...
Node;AmplifyShaderEditor.CommentaryNode;2167;1562.646,-1664.731;Float;False;3075.19;748.0726;Smoothness;24;2280;2283;2279;2281;2284;2282;1820;2083;1151;1589;1153;1152;65;35;145;1826;984;2091;1821;64;1366;1819;1813;2459;Smoothness;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;195;-17.86369,1106.485;Float;False;Property;_globalnormalstrength;global normal strength;10;0;Create;1;1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2283;1977.369,-1102.003;Float;False;Property;_snowspecklestrengthdetail2;snow speckle strength detail 2;45;0;Create;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2279;1975.369,-1174.003;Float;False;Property;_snowspecklestrengthdetail1;snow speckle strength detail 1;44;0;Create;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;753;135.9904,337.849;Float;False;Property;_GlobalColorDetail2;GlobalColorDetail2;27;0;Create;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;752;134.9904,243.8491;Float;False;Property;_GlobalColorDetail1;GlobalColorDetail1;26;0;Create;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1820;2140.646,-1437.666;Float;False;Property;_snowspecklestrength;snow speckle strength;42;0;Create;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;723;682.5818,580.0234;Float;False;Property;_globalColorFarMultiplier;globalColorFarMultiplier;24;0;Create;0.9;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2303;-1.976745,2286.046;Float;False;Property;_closedetailDetail3;close detail Detail 3;18;0;Create;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2305;-8.976697,2030.047;Float;False;Property;_closedetailDetail0;close detail Detail 0;15;0;Create;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;750;128.9904,164.8491;Float;False;Property;_GlobalColorDetail0;GlobalColorDetail0;25;0;Create;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;754;135.9904,420.849;Float;False;Property;_GlobalColorDetail3;GlobalColorDetail3;28;0;Create;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2449;1042.72,472.6083;Float;False;Distance Based Mask Multiplier;-1;;1794;799ac193d9a7f7a4bae908a42e277362;8;23;FLOAT;1.0;False;19;FLOAT;1.0;False;20;FLOAT;1.0;False;21;FLOAT;1.0;False;22;FLOAT;1.0;False;24;FLOAT;1.0;False;25;FLOAT;1.0;False;26;FLOAT;1.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1167;1054.776,1641.908;Float;False;Property;_closenoisenormalscale;close noise normal scale;13;0;Create;1;0.95;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2457;2939.041,-1079.061;Float;False;Constant;_Float4;Float 4;64;0;Create;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;696.5347,2001.284;Float;False;Property;_closedetailglobalstrength;close detail global strength;12;0;Create;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1826;2753.245,-1548.366;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMinOpNode;2459;3095.041,-1235.061;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.BlendNormalsNode;152;1643.935,1213.284;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;35;3264.209,-1348.234;Float;False;Property;_smoothness;smoothness;32;0;Create;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;153;2024,1140;Float;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0.0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;2453;3883.789,559.3609;Float;False;656.6377;505;Comment;6;2166;2092;980;2084;193;0;Output;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RelayNode;2464;-5518.693,-1230.787;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RelayNode;2465;3993.212,1090.767;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RelayNode;2461;-4718.148,-1344.898;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;4286.427,609.3609;Float;False;True;3;Float;ASEMaterialInspector;0;0;Standard;2SD/2SD_Terrain;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;Back;0;0;False;0;0;Opaque;0.5;True;True;0;False;Opaque;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;0;0;0;0;False;0;4;10;25;False;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;0;False;1;BaseMapShader=2SD/2SD_Terrain_Far;0;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;2470;72;1526;0
WireConnection;2470;65;1527;0
WireConnection;2470;66;1528;0
WireConnection;2470;67;1529;0
WireConnection;2470;73;2354;0
WireConnection;2470;68;2355;0
WireConnection;2470;69;2356;0
WireConnection;2470;70;2357;0
WireConnection;2451;0;2450;0
WireConnection;2408;0;2470;71
...
WireConnection;2406;0;2470;0
WireConnection;2311;0;2310;0
WireConnection;2311;1;1989;2
WireConnection;2407;0;2470;64
...
WireConnection;2462;1;2340;0
WireConnection;2462;16;2341;0
WireConnection;2462;17;2342;0
WireConnection;2462;19;2343;0
...
WireConnection;273;0;2462;0
WireConnection;281;0;2462;20
...
WireConnection;755;1;2449;0
WireConnection;2459;0;984;0
WireConnection;2459;1;2457;0
...
WireConnection;145;0;1826;0
WireConnection;145;1;2091;0
WireConnection;145;2;2459;0
...
ASEEND*/
//CHKSM=970AD352BD6FBF6338FB4A6C02B0312FCB63B894